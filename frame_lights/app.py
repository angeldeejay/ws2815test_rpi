...
class LedStrip:
    def __init__(self, name, gpio_pin=None, led_count=None, reverse=None, animation=None, interval=None):
        self.name = name
        ...
        self.dma = 10
        self.brightness = 255
        self.interval = float(self.__default_value(reverse, 0.1))
...
if __name__ == '__main__':
    ...
    test_strip_top = LedStrip(name='WS2815 - TOP', gpio_pin=18, led_count=300, animation=animation_mock)
